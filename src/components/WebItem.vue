<template>
  <div>
    <h4 class="text-gray">
      <i class="fa-circle-o" :id="transName(item)"></i>
      {{transName(item)}}
    </h4>
    <div class="row urls-box">
      <div class="col-sm-3 url-card" v-for="(web, idx) in item.web" :key="idx">
        <div class="xe-widget xe-conversations box2 label-info" title=""
          ...
          <div class="xe-comment-entry">
            ...
            <div class="xe-comment">
              ...
              <p class="overflowClip_1">{{web.desc}}</p>
            </div>
          </div>
        </div>
      </div>
